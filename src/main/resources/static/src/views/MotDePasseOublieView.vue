...
import { profilLabel, typeEtablissementLabel } from '../i18n';
              ...
              <div class="field-container">
                <div class="middle">
                  ...
                  <select id="known-profil" v-model="knownProfil" @change="clearMessage">
                    ...
                    <option v-for="p in knownProfils" :key="p" :value="p">{{ profilLabel(p) }}</option>
                  </select>
                </div>
              </div>
              <div class="active-indicator"></div>
              ...
              <div class="field-container">
                <div class="middle">
                  ...
                  <select id="recover-type" v-model="recoverType" @change="onRecoverTypeChange">
                    <option value="" disabled selected hidden></option>
                    <option v-for="t in recoverTypes" :key="t" :value="t">{{ typeEtablissementLabel(t) }}</option>
                  </select>
                </div>
              </div>
              <div class="active-indicator"></div>
